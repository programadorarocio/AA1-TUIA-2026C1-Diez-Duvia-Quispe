...
Este proyecto corresponde al Trabajo Práctico N°2 de la asignatura Aprendizaje Automático I.
El objetivo del trabajo práctico es obtener un programa ejecutable de Docker que sea capaz de predecir si llueve o no al día siguiente. Se van a usar herramientas como Scikit-learn, TensorFlow y Docker.

---

## Dataset

Se utilizó el dataset `weatherAUS_2026C1.csv`, que contiene información climática de Australia de los últimos diez años.
